#categories.py
#Mitchell Campbell
'''The purpose of this file is to separate out the category selection code from the main.py file for cleaner and more efficient code'''


def item_category_confirmation(item_category_title):
    '''This function allows the user to confirm their item category/subcategory choice'''
    while True: 
...
def category_choice():
    '''This function allows the user to select the category of their item.'''
    while True:
        ...
        if item_category in ("electronics", "electronic", "1"):
            ...
            item_category_name = "Clothing/Apparel"
        ...
        elif item_category in ("quit", "exit"):
            break
        else:
        ...
        quit_answer = str()
        if item_category in ("quit", "exit"):
            while True:
                quit_confirmation = ("Are you sure you want to stop adding items? ").strip().lower()
                if quit_confirmation in ("yes", "y"):
                    quit_answer = "y"
                    break
                elif quit_confirmation in ("no", "n"):
                    quit_answer = "n"
                    break
                else: 
        ...
        if quit_answer == "y":
            ...
            continue
        elif item_cat_conf_answer == "y":
            return item_category_name
        elif item_cat_conf_answer == "n":
            continue

def elect_subcat():
    '''Select the subcategory for an electronics item.'''
    while True:
        ...
        if elect_sub_cat_name_answer == "y":
            return elect_sub_cat_name
        elif elect_sub_cat_name_answer == "n":
            continue

def auto_subcat():
    '''Select the subcategory for an automotive item.'''
    while True:
        ...
        if auto_sub_cat_name_answer == "y":
            return auto_sub_cat_name
        elif auto_sub_cat_name_answer =="n":
            continue

def clothing_subcat():
    '''Select the subcategory of a clothing/apparel item.'''
    while True:
        ...
        if clothing_sub_cat_name_answer == "y":
            return clothing_sub_cat_name
        elif clothing_sub_cat_name_answer == "n":
            continue

def home_subcat():
    '''Select the subcategory of a home/furniture item.'''
    while True:
        ...
        if home_sub_cat_name_answer == "y":
            return home_sub_cat_name
        elif home_sub_cat_name_answer == "n":
            continue

def collect_subcat():
    '''Select the subcategory of a collectibles item.'''
    while True:
        ...
        if collect_sub_cat_name_answer == "y":
            return collect_sub_cat_name
        elif collect_sub_cat_name_answer == "n":
            continue

def toy_subcat():
    '''Select the subcategory of a toys/games item.'''
    while True:
        ...
        if toy_sub_cat_name_answer == "y":
            return toy_sub_cat_name
        elif toy_sub_cat_name_answer == "n":
            continue
    
def books_subcat():
    '''Select the subcategory of a books/media item.'''
    while True:
        ...
        if books_sub_cat_name_answer == "y":
            return books_sub_cat_name
        elif books_sub_cat_name_answer == "n":
            continue

def sports_subcat():
    '''Select the subcategory of a sports/outdoors item.'''
    while True:
        ...
        if sports_sub_cat_name_answer == "y":
            return sports_sub_cat_name
        elif sports_sub_cat_name_answer == "n":
            continue

def jewelry_subcat():
    '''Select the subcategory of a jewelry/accessories item.'''
    while True:
        ...
        if jewelry_sub_cat_name_answer == "y":
            return jewelry_sub_cat_name
        elif jewelry_sub_cat_name_answer == "n":
            continue

def beauty_subcat():
    '''Select the subcategory of a beauty/personal care item.'''
    while True:
        ...
        if beauty_sub_cat_name_answer == "y":
            return beauty_sub_cat_name
        elif beauty_sub_cat_name_answer == "n":
            continue

def hobb_subcat():
    '''Select the subcategory of a hobbies/crafts item.'''
    while True:
        ...
        if hobb_sub_cat_name_answer == "y":
            return hobb_sub_cat_name
        elif hobb_sub_cat_name_answer == "n":
            continue

def ind_subcat():
    '''Select the subcategory of an industrial/business equipment item.'''
    while True:
        ...
        if ind_sub_cat_name_answer == "y":
            return ind_sub_cat_name
        elif ind_sub_cat_name_answer == "n":
            continue

def misc_subcat():
    '''Select the subcategory of a miscellaneous item.'''
    while True:
        ...
        elif misc_sub_cat in ("religious", "religion", "religious items", "6"):
            misc_sub_cat_name = "Religious Items"
        elif misc_sub_cat in ("seasonal", "season", "holiday", "holidays", "christmas", "thanksgiving", "halloween", "easter", "fourth of july", "seasonal/holiday", "holidays", "7"):
            misc_sub_cat_name = "Seasonal/Holiday"
        elif misc_sub_cat in ("promotion", "promotional", "promotional merch", "promotional merchandise", "8"):
            misc_sub_cat_name = "Promotional Merchandise"
        elif misc_sub_cat in ("specialty", "special", "specialty items", "9"):
            misc_sub_cat_name = "Specialty Items"
        elif misc_sub_cat in ("Other"):
            misc_sub_cat_name = "Other"
        else:
            print("Sorry, that's not a valid option.")
            print("Please select a valid option or enter its corresponding number.")
            continue
...
item_cat = category_choice()
print(item_cat)
if item_cat == "Electronics":
    print(elect_subcat())