...
if menu_choice == "calculations":
    ...
    #create loop to do entire single or multiple item calculations *******?
    ...
    while True:
        ...
        #either move on to next step, restart if user chose wrong category, or quit out
        ...
        if quit_answer == "n":
            ...
            item_classification = item_category_name
            break
    ...
    print(f"Alright, this item is in the {item_classification} category, specifically under {item_sub_cat}.")
    while True:
